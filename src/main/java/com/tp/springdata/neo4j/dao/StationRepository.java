...
public interface StationRepository extends GraphRepository<Station> {
	...
	@Transactional
	@Query("MATCH (departure:Station { stationName:{departureStation} }),(arrival:Station { stationName:{arrivalStation} }), p = shortestPath((departure)-[*]-(arrival))RETURN p")
	List<BaseEntity> getShortestPath(@Param("departureStation") String start,
